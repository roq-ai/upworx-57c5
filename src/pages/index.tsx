  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Upworx: Streamlining your business operations by providing owners, recruiters, and freelancers a unified platform for job offers, applications, and contracts management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Upworx: Streamlining your business operations by providing owners, recruiters, and freelancers a unified platform for job offers, applications, and contracts management.`}
            </Text>
            <Box
